...
Widget verticalMarginSmall() => const SizedBox(height: 2);

Widget verticalMarginMedium() => const SizedBox(height: 4);

Widget verticalMarginLarge() => const SizedBox(height: 6);

Widget verticalMarginExtraLarge() => const SizedBox(height: 10);
...
class WorkoutOfTheDayCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const InkWell(child: Card(child: Column(children: [])));
  }
}
      ...
      child: Card(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Text(title, style: fontStyleMenuTitle),
              Text(subtitle, style: fontStyleMenuSubtitle),
            ],
          ),
        ),
        elevation: 6,
...
Widget iconWidgetButton({
  ...
  return Padding(
    ...
    child: InkWell(
      onTap: () => func(),
      child: Icon(icon, size: size, color: tollandCrossFitBlue),
    ),
  );
}
