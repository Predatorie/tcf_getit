...
abstract class ApiService extends ChopperService {
  static ApiService create() {
    final client = ChopperClient(
      baseUrl: Uri.parse('https://api.sugarwod.com'),
  ...
  Future<Response> getMovement(@Path('movementId') String movementId);
  ...
  Future<Response> getWorkoutsFilterByDate(@Query('date') int date);
  ...
  Future<Response> getWorkoutsFilterByTrack(@Path('trackId') String trackId);
