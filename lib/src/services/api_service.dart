...
abstract class ApiService extends ChopperService {
  ...
  Future<Response> getAthletesRole(
    @Path('athletesRole') String athletesRole,
  );

  /// Returns a single Athlete from this Affiliate by Id.
  @Get(path: '/athletes/{id}')
  Future<Response> getAthlete(
    @Path('id') String id,
  );
  ...
  Future<Response> getAthletePerformanceSummary(
    @Path('id') String id,
  );
  ...
  Future<Response> searchAthleteByEmail(
    @Path('email') String email,
  );

  /// Returns a summary of this Athlete's participation metrics, suitable for
  /// embedding in a dashboard. Will include current workout, fist bump and comment counts.
  @Get(path: '/athletes/{id}/summary/participation')
  Future<Response> getAthletePerformanceParticipation(
    @Path('id') String id,
  );
  ...
  Future<Response> getBarbellLift(
    @Path('barbellliftId') String barbellliftId,
  );

  /// A Benchmark is a workout template which may be scheduled on an Affiliate's
  /// workout calendar, or logged directly by an Athlete in their Personal Logbook.
  ///
  ...
  Future<Response> getBenchmark(
    @Path('benchmarkId') String benchmarkId,
  );
  ...
  /// A Track is calendar of Workouts scheduled for a particular group of athletes.
